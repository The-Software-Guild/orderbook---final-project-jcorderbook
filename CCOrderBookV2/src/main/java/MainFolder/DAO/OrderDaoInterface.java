...
public interface OrderDaoInterface {
    ...
    String getTradeNumber() throws TradePersistenceException;
    
    Trade addTrade(Trade trade) throws TradePersistenceException;
    
    public void clearTables(boolean clearBuy, boolean clearSell, boolean clearTrades) throws OrderPersistenceException;
    
    List<Trade> getAllTrades() throws TradePersistenceException;
