...
public class TableGenerator {
	 ...
	 * @param overRiddenHeaderHeight the over ridden header height
	 * @return the string
	 */
	...
	private void createRowLine(
		StringBuilder stringBuilder, int headersListSize,
	...
	private void fillCell(
		StringBuilder stringBuilder, String cell,
		int cellIndex, Map<Integer, Integer> columnMaxWidthMapping) {
